...
namespace pr {
  ...
  public:
    PixelJob(Scene &scene, std::vector<Vec3D> &lights, const Scene::screen_t &screen, Color *pixels, int x, int y) : scene(scene), lights(lights), screen(screen), pixels(pixels), x(x), y(y) {}
